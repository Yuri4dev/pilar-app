  ...
  <form>
    <div class="relative w-full">
      ...
      <input
        type="search"
        id="search"
        class="block p-4 pl-10 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:ring-blue-500 focus:border-blue-500"
        placeholder="Search"
        required
      />
      <button
